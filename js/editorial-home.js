(() => {
  ...
  (async()=>{try{await load('/js/passport-phase1-discovery.js?v=20260830');await load('/js/passport-phase2-home.js?v=20260830');await load('/js/global-signals-lib.js?v=5');await Promise.all([load('/js/global-signals-home.js?v=6'),load('/js/home-support.js?v=5')]);await load('/js/home-editorial-priority.js?v=202608311324');await load('/js/home-rising-reactions.js?v=3');}catch(e){console.error('Passport Home Wire',e)}})();
})();