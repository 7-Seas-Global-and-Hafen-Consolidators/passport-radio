...
(() => {
  ...
  const CHANNELS = {
    ...
    unplugged: { label: "UNPLUGGED I™", stream: "https://streams.radio7.de/unplugged/mp3-192/web/" },
    regenbogen: { label: "UNPLUGGED II™", stream: "https://stream.regenbogen.de/unplugged/mp3-128/stream.regenbogen.de/" },
  ...
  function buildPlayer() {
    ...
    if (!host) return;
    host.innerHTML = `<section class="passport-live-panel"><div class="passport-live-head"><div><small>PASSPORT RADIO</small><strong id="passport-live-channel-name">METAL</strong></div></div><div class="passport-live-channels"><button type="button" class="passport-live-channel is-active" data-live-channel="metal">METAL</button><button type="button" class="passport-live-channel" data-live-channel="unplugged">UNPLUGGED I™</button><button type="button" class="passport-live-channel" data-live-channel="regenbogen">UNPLUGGED II™</button><button type="button" class="passport-live-channel" data-live-channel="metalwarriors">HEAVY METAL</button><button type="button" class="passport-live-channel" data-live-channel="gothic">GOTHIC PASSPORT™</button><button type="button" class="passport-live-channel" data-live-channel="livejam">LIVE JAM</button></div><div class="passport-live-controls"><button id="passport-live-play" type="button" class="passport-live-play" aria-label="Ouvir ao vivo" title="Ouvir ao vivo">▶</button><span id="passport-live-status">PRONTO</span></div><audio id="passport-live-audio" preload="none"></audio></section>`;
