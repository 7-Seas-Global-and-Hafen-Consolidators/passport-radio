(() => {
  const stories = [
    ...
    {title:'Festa PLOC: você cresceu. A pista não recebeu o memorando.',short:'Festa PLOC: a matéria virou a própria festa.',deck:'Balão Mágico, Paquitas, Ritchie, Madonna, Michael Jackson, Depeche Mode, Cyndi Lauper, Safety Dance e dezenas de performances ao vivo escolhidas a dedo.',url:'/editorial/2026/09/03/festa-ploc-musicas-anos-80-nostalgia-shows-ao-vivo.html',image:'https://img.youtube.com/vi/w_1jWR76qCY/maxresdefault.jpg',alt:'Festa PLOC — músicas dos anos 80 e performances ao vivo',meta:'NOVO · Mr. Nomad · FESTA PLOC · LIVE DNA'},
