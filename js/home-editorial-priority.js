(() => {
  const stories = [
    {title:'Polyphia Be Not Afraid: por que o novo álbum muda o som da banda?',short:'Polyphia Be Not Afraid: o novo peso aparece quando você escuta a banda inteira.',deck:'Tim Henson chama os olhos. Scott LePage, Clay Gober e Clay Aeschliman explicam o resto. Entre oito cordas, baixo, bateria e eletrônica, o Polyphia muda de idioma sem deixar de ser Polyphia.',url:'/editorial/2026/08/28/polyphia-anuncia-novo-album-be-not-afraid.html',image:'https://img.youtube.com/vi/3vFUkUD8u-o/maxresdefault.jpg',alt:'Polyphia ao vivo com Tim Henson, Scott LePage, Clay Gober e Clay Aeschliman',meta:'DESTAQUE · Mr. Nomad · Music DNA · Polyphia · 01/09/2026'},
