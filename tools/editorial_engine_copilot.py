...
Worldwide discovery stays multilingual; public output is original pt-BR journalism.
Operation target: 500/day, capacity: 700/day, max batch: 12/run.
"""
...
# Operation 26/8 restores the approved 12-story batch envelope without changing
# the shared base engine used by other validation paths.
...
def call_copilot(candidate, source_text, config):
    ...
    env["COPILOT_GITHUB_TOKEN"] = token; env["GH_TOKEN"] = token; env["GITHUB_TOKEN"] = token
